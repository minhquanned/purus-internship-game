...
async function initializeGame() {
    try {
        // Load Ammo.js from a single, reliable source
        ...
        // Register physics components before creating the app
        app.systems.add(new pc.RigidBodyComponentSystem(app));
        app.systems.add(new pc.CollisionComponentSystem(app));
        ...
        // Ensure physics world is properly set up in the app
        if (!app.systems.rigidbody) {
            throw new Error('RigidBody system not initialized');
        }
        app.systems.rigidbody.physicsWorld = physicsWorld;

        // Store Ammo globally for component access
        window.Ammo = AmmoLib;
        ...
        // Wait for a frame to ensure systems are initialized
